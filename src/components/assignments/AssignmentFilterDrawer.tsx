...
interface AssignmentFilterDrawerProps {
  open: boolean;
  onClose: () => void;
...
const AssignmentFilterDrawer: React.FC<AssignmentFilterDrawerProps> = ({
  open,
  onClose,
  schema,
  onApply,
  ...
  const handleSavePreset = () => {
    if (presetName) {
      ...
      localStorage.setItem('assignmentFilterPresets', JSON.stringify(updatedPresets));
      setPresetName('');
    }
  };
