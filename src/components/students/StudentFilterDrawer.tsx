...
const StudentFilterDrawer: React.FC<StudentFilterDrawerProps> = ({
  open,
  onClose,
  schema,
  onApply,
  ...
  useEffect(() => {
    ...
    const savedPresets = localStorage.getItem('studentFilterPresets');
    if (savedPresets) {
  ...
  const handleSavePreset = () => {
    if (presetName) {
      ...
      localStorage.setItem('studentFilterPresets', JSON.stringify(updatedPresets));
      setPresetName('');
    }
  };
