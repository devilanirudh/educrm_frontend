...
import InventoryCategoryForm from '../../components/inventory/InventoryCategoryForm';
...
const InventoryCategoriesPage: React.FC = () => {
  ...
  const { categories, isCategoriesLoading, createCategory, updateCategory, deleteCategory } = useInventory();

  const handleOpen = (category: InventoryCategory | null = null) => {
    ...
    <Box>
      ...
      <Modal open={open} onClose={handleClose}>
        <Box sx={style}>
          ...
          <InventoryCategoryForm onSubmit={handleSubmit} initialValues={editingCategory} />
        </Box>
      </Modal>
